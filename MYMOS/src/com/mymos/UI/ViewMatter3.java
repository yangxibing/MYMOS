...
public class ViewMatter3 extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		this.setContentView(R.layout.matter3);
		...
		SimpleAdapter simpleAdapter = new SimpleAdapter(this, listItems,
				R.layout.matter3_item, new String[] { "matterName",
						"date" }, new int[] { R.id.matter3_name,
						R.id.matter3_time });

		ListView list = (ListView) findViewById(R.id.matter3_list);
