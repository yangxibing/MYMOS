...
public class ViewMatter1 extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		this.setContentView(R.layout.matter1);
		...
		SimpleAdapter simpleAdapter = new SimpleAdapter(this, listItems,
				R.layout.matter1_item, new String[] { "matterName", "date" },
				new int[] { R.id.matter1_name, R.id.matter1_time });

		ListView list = (ListView) findViewById(R.id.matter1_list);
