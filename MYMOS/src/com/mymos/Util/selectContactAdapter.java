...
public class selectContactAdapter extends BaseAdapter{
	...
	public selectContactAdapter(Context context, List<ContactBean> list, QuickAlphabeticBar alpha) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			...
			holder.checkB = (CheckBox) convertView.findViewById(R.id.checkB);
		...
		if (!previewStr.equals(currentStr)) { 
		 ...
		 holder.checkB.setChecked(isSelected.get(position));
		return convertView;
	}
